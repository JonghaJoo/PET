...
class Loss:
    ...
    def normalization_loss(src,output, y_true, energy, device, min_y, max_y):
        ...
        print('MSE Loss / Phys Loss normalization/ Phys Loss normalization_new {:.8f}/{:.8f}/{:.8f}'.format(mse_loss_init, phys_loss_init, phys_loss_new_init), end='\r')
...
# %%
class Trainer:
    def __init__(self, model, optimizer, device, min_y, max_y, alpha, beta, mse_loss_init, phys_loss_init, phys_loss_new_init):
        self.model = model
    ...
    def train_epoch(self, dataloader, criterion):
        ...
        for batch in dataloader: 
            ...
            output, energy = self.model(src, data_length) 
        ...
        return total_loss / len(dataloader), train_predictions, indices , X_predictions 
